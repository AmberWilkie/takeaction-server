...
article1.action_items.create(action_id: action5.id, email: 'legislator@riksdagen.se', info: 'Sample email: Dear legislator,<br>It would be so great if you could not vote for this terrible bill coming up.')
